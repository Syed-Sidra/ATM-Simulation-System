...
public class MiniStatement extends javax.swing.JFrame {
    ...
    MiniStatement(String pinnumber) {
       ...
       try{
           ...
           db.rst = db.st.executeQuery("select * from login where pin = '"+pin+"'");
           while(db.rst.next()){
               jLabel4.setText("Card Number : " + db.rst.getString("cardno").substring(0,4) + "XXXXXXXX" + db.rst.getString("cardno").substring(12));
           }
       }
       catch(Exception e){
           e.printStackTrace();
    ...
    while (db.rst.next()) {
        jLabel2.setText(jLabel2.getText() + "<html>" + db.rst.getString("date") + " " + db.rst.getString("type") + " " + db.rst.getString("amount") + "<br><br><html>");

        if (db.rst.getString("type").equals("Deposit")) {
            bal += Integer.parseInt(db.rst.getString("amount"));
        } else {
            bal -= Integer.parseInt(db.rst.getString("amount"));
        }
    }

    jLabel5.setText("Your current balance is Rs " + bal);
